...
///     }
///
library m4d_dnd.services;

import 'package:m4d_core/m4d_ioc.dart';


/// Application DND Events
///
///     IOCContainer().bind(DNDEvent).to(return <String,Function>{
///         "onAdd" : onAdd
///     };);
///
final DNDEvents =  Service("m4d_dnd.DNDEvents",ServiceType.Function);
