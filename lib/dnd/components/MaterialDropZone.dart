...
class MaterialDropZone extends MdlComponent {
    ...
    static MaterialDropZone widget(final dom.HtmlElement element)
        => mdlComponent(element,MaterialDropZone) as MaterialDropZone;
    ...
    void _init() {
        ...
        _dropzone = new Dropzone(element, overClass: _cssClasses.OVER ,
            acceptor: new _MdlAcceptor(_dragInfo,_getZoneNames));
    ...
    void _onDrop(final DropzoneEvent event) {
        ...
        if (onDropSuccessCallback != null) {
            ...
            _logger.fine("Call callback (${_dragInfo.data})");
